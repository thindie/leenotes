...
import com.example.thindie.leenotes.data.di.SummaryRepositoryModule
...
@Component(
    ...
    modules = [NotesStatisticsViewModelModule::class, ViewModelFactoryModule::class, SummaryRepositoryModule::class]
)
interface NoteStatisticsComponent {
    companion object {
        fun init(dependenciesProvider: DependenciesProvider): NoteStatisticsComponent {
            return DaggerNoteStatisticsComponent.factory().create(dependenciesProvider)
        }
    }
